...
**Repository:** [github.com/Rethunk-AI/rethunk-github-mcp](https://github.com/Rethunk-AI/rethunk-github-mcp) · **GitHub Packages (CI on each tag):** [`@rethunk-ai/github-mcp`](https://github.com/Rethunk-AI/rethunk-github-mcp/packages) — see [docs/install.md](docs/install.md) and [HUMANS.md](HUMANS.md) Publishing.
...
| **`my_work`** | Cross-repo personal queue: your open PRs, review requests, assigned issues |
| **`pr_preflight`** | Pre-merge safety check: mergeable, reviews, CI, behind-base, computed `safe` verdict |
